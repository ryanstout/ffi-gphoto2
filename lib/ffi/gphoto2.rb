...
module FFI
  module GPhoto2
    ...
    attach_function :gp_camera_set_abilities, [Camera.by_ref, CameraAbilities.by_value], :int, blocking: true
    attach_function :gp_camera_set_port_info, [Camera.by_ref, GPhoto2Port::GPPortInfo], :int, blocking: true
    attach_function :gp_camera_exit, [Camera.by_ref, GPContext.by_ref], :int, blocking: true
    attach_function :gp_camera_ref, [Camera.by_ref], :int, blocking: true
    attach_function :gp_camera_unref, [Camera.by_ref], :int, blocking: true
    ...
    attach_function :gp_camera_folder_list_files, [Camera.by_ref, :string, CameraList.by_ref, GPContext.by_ref], :int, blocking: true
    attach_function :gp_camera_folder_list_folders, [Camera.by_ref, :string, CameraList.by_ref, GPContext.by_ref], :int, blocking: true
    attach_function :gp_camera_file_get_info, [Camera.by_ref, :string, :string, CameraFileInfo.by_ref, GPContext.by_ref], :int, blocking: true
    ...
    attach_function :gp_camera_file_delete, [Camera.by_ref, :string, :string, GPContext.by_ref], :int, blocking: true
    ...
    attach_function :gp_filesystem_enable_cache_check, [], :void, blocking: true
    attach_function :gp_filesystem_disable_cache_check, [], :void, blocking: true
    attach_function :gp_camera_wait_for_event_no_cache, [], :void, blocking: true
    attach_function :gp_camera_wait_for_event_default_cache, [], :void, blocking: true
    ...
    attach_function :gp_context_unref, [GPContext.by_ref], :void, blocking: true
    ...
    attach_function :gp_file_set_data_and_size, [CameraFile.by_ref, :pointer, :int], :int, blocking: true
    # int gp_file_set_mime_type (CameraFile *file, const char *mime_type)
    attach_function :gp_file_set_mime_type, [CameraFile.by_ref, :string], :int, blocking: true
    # int gp_file_new_from_fd (CameraFile **file, int fd)
    attach_function :gp_file_new_from_fd, [:pointer, :int], :int, blocking: true
    ...
    attach_function :gp_widget_set_changed, [CameraWidget.by_ref, :int], :int, blocking: true
    attach_function :gp_widget_get_readonly, [CameraWidget.by_ref, :pointer], :int, blocking: true
    ...
    attach_function :gp_widget_get_value, [CameraWidget.by_ref, :pointer], :int, blocking: true
    attach_function :gp_widget_get_name, [CameraWidget.by_ref, :pointer], :int, blocking: true
    attach_function :gp_widget_get_type, [CameraWidget.by_ref, :pointer], :int, blocking: true
    attach_function :gp_widget_get_label, [CameraWidget.by_ref, :pointer], :int, blocking: true
    attach_function :gp_widget_get_range, [CameraWidget.by_ref, :pointer, :pointer, :pointer], :int, blocking: true
    attach_function :gp_widget_count_choices, [CameraWidget.by_ref], :int, blocking: true
    attach_function :gp_widget_get_choice, [CameraWidget.by_ref, :int, :pointer], :int, blocking: true
  end
end
